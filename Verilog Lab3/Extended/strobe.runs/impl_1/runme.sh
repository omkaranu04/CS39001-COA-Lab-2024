...
HD_PWD='D:/Third Year/COA Lab/Verilog Lab3/Extended/strobe.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log secure_router.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source secure_router.tcl -notrace
