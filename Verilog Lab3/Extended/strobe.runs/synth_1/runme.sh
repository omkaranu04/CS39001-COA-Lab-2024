...
HD_PWD='D:/Third Year/COA Lab/Verilog Lab3/Extended/strobe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log secure_router.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source secure_router.tcl
