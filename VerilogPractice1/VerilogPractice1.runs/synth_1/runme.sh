...
HD_PWD='D:/Third Year/COA Lab/VerilogPractice1/VerilogPractice1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log half_adder_behav.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source half_adder_behav.tcl
